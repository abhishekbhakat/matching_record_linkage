#!/usr/bin/env python3
"""Standalone Polars Bloom Jaccard benchmark runner."""
...
from matcher_native import polars_bloom_match_native as polars_bloom_match


def run_benchmark(data_path: str, threshold: float) -> dict:
    """Run Polars Bloom Jaccard benchmark on provided data."""
